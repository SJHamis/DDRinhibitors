...
{
    double drug_dose=0;//19;//50*0.33;//12.5;//Drug doese (in micromole)
    double mu_in=24000;//24000;//24000;
    double sigma_in=500;//500;
    ...
    for(int t=0; t <= end_time; t++)
    {
        ...
        if(t%(24*hour)==0)
        {
            ...
            printf("In loop. Time: %d. No Cells: %d.\n",t,no_cells);
                    ...
                    CreateOutputScalarFieldMaps2(n_field_caption);
                    n_caption++;
                    n_field_caption++;
        }
