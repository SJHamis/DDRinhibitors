function [t,y,yH2AXtotal,totalcells] = ATR_simulation_from_checkley_etal2015(drug_dose)

%This code function is taken from Checkley et al 2015
%DOI: 10.1038/srep13545
...
parameters(24) = 0; %washout toggle (1=yes, 0=no)
parameters(25) = 0; % IR dose at t=0hr (1=yes, 0=no)

timespan = 0:1:72;%ATR_simulation(drug_dose)% [0 72];
...
%% single trajectory
[t,y] = ode23s(@(timespan, initial_conditions) ATR_model_from_checkley_etal2015(timespan, initial_conditions, parameters), timespan, initial_conditions);
